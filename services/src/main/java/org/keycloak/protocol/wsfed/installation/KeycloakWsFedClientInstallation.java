 ...
 * @date 9/28/2016
 */
public class KeycloakWsFedClientInstallation implements ClientInstallationProvider {
    ...
    public String getDisplayType() {
        return "Keycloak WS-Fed Adapter keycloak-wsfed.xml";
    }

    @Override
    public String getHelpText() {
        return "Keycloak WS-Fed adapter configuration file.  Put this in WEB-INF directory of your WAR.";
    }

    @Override
    public String getFilename() {
        return "keycloak-wsfed.xml";
    }
