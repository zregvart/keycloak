...
public class SAML2RequestedTokenParser extends AbstractParser {
    ...
    public Object parse(XMLEventReader xmlEventReader) throws ParsingException {
        ...
        try {
            ...
            StaxParserUtil.validate(startElement, SAML2RequestedTokenWriter.REQUESTED_TOKEN);
            while (xmlEventReader.hasNext()) {
                ...
                if (xmlEvent instanceof EndElement) {
                    ...
                    if (endElementName.equals(SAML2RequestedTokenWriter.REQUESTED_TOKEN))
                        break;
                    else
                ...
                if (tag.equals(SAML2RequestedTokenWriter.WSFEDRESPONSE_RAW)) {
                    StartElement element = StaxParserUtil.getNextStartElement(xmlEventReader);
                    wsFedResponse = new String(Base64.decode(StaxParserUtil.getElementText(xmlEventReader)));
                } else if (tag.equals(SAML2RequestedTokenWriter.ASSERTION)) {
                    StartElement element = StaxParserUtil.getNextStartElement(xmlEventReader);
                    ...
                    assertion = AssertionType.class.cast(respType);
        ...
        return SAML2RequestedToken.createSAML2RequestedToken(wsFedResponse, assertion);
    }
