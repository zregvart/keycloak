...
public class SAML11RequestedTokenWriter {

    public final static String REQUESTED_TOKEN_PREFIX = "my";
    public final static String REQUESTED_TOKEN = "RequestedToken";
    public final static String REQUESTED_TOKEN_NSURI = "urn:my:names:tc:SAML:1.0:requestedtoken";
    public final static String WSFEDRESPONSE_RAW = "WsFedResponse";
    public final static String ASSERTION = "Assertion";
    protected XMLStreamWriter writer = null;

    public SAML11RequestedTokenWriter(XMLStreamWriter writer) {
        this.writer = writer;
    }

    public void write(SAML11RequestedToken requestedToken) throws ProcessingException {
        ...
        SAML11AssertionType assertion = requestedToken.getAssertionType();
