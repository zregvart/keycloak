...
public interface WSFedConstants {
    ...
    */
    ...
    /**
     * A requested RST parameter was not accepted by the STS. The details element contains a fed:Unaccepted element.
     * This element&rsquo;s value is a list of the unaccepted parameters specified as QNames.
