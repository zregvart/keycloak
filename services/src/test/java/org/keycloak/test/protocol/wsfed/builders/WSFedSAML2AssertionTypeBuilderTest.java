...
import org.keycloak.protocol.wsfed.builders.SAML11AssertionTypeBuilder;
...
public class WSFedSAML2AssertionTypeBuilderTest {
    ...
    public void testSamlTokenGeneration() throws Exception {
        ...
        assertEquals(XMLTimeUtil.add(token.getConditions().getNotBefore(), mockHelper.getAccessCodeLifespan() * 1000 + SAML11AssertionTypeBuilder.CLOCK_SKEW), token.getConditions().getNotOnOrAfter());
